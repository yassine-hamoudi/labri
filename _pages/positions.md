...
<details markdown=block>
  ...
  <blockquote>
  ![file]({{ site.url }}{{ site.baseurl }}/images/logo/email.png){: style="vertical-align:middle; max-width: 40px; height: auto;"} [Detailed project]({{ site.url }}{{ site.baseurl }}/files/Huber_Tanasa.pdf)
...
<details>
  <summary>
    Quantum Graphs (with Ion Nechita and Adrian Tanasa)
  </summary>
  <blockquote>
  ![file]({{ site.url }}{{ site.baseurl }}/images/logo/email.png){: style="vertical-align:middle; max-width: 40px; height: auto;"} [Detailed project]({{ site.url }}{{ site.baseurl }}/files/Nechita_Tanasa.pdf)
